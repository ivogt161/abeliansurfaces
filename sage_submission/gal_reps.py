...
from .jacobian_generic import geometric_endomorphism_ring_is_ZZ
...
class GaloisRepresentation(SageObject):
    ...
    def get_cuspidal_levels(self, N, max_cond_exp_2=None):
        ...
        if max_cond_exp_2 is not None:
            ...
            return list(
                set([d for N in possible_conductors for d in self.special_divisors(N)])
        ...
        *might* not be surjective. If `p` is not in the returned list,
        ...
        while not sufficient_p:
            ...
            if N % p != 0:
                ...
                M2p2nsd, y2p2nsd = self.rule_out_2_plus_2_nonselfdual_via_Frob_p(
